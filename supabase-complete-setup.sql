-- ============================================
-- Complete Supabase Database Setup for OPEC
-- Run this in Supabase Dashboard → SQL Editor
-- ============================================

-- ============================================
-- 1. CHAT MESSAGES TABLE (for AI chatbot)
-- ============================================
...
-- ============================================
-- 3. CHECK_INS TABLE (mood tracking)
-- ============================================
...
BEGIN
  ...
  IF v_last_date = v_today THEN
    ...
    SET last_checkin_date = v_today, updated_at = now()
    WHERE user_id = new.user_id;
    RETURN new;
  END IF;
...
-- ============================================
-- Next steps:
-- 1. Add GEMINI_API_KEY in Supabase Dashboard → Settings → Edge Functions → Secrets
-- 2. Deploy Edge Functions (ai-chat and mood-checkin-ai)
-- 3. Test the chatbot!
-- ============================================
